...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Shared observer options to avoid redeclaration conflicts
    const sharedObserverOptions = { threshold: 0.2 };
    ...
    if (whyJoinSection) {
        ...
        whyObserver.observe(whyJoinSection);
    }
});
...
function submitCareerApplication(form) {
    ...
    if (USE_BACKEND && API_ENDPOINT) {
        ...
        .catch(error => {
            ...
            showCareerMessage('Sorry, there was an error submitting your application. Please try again or contact us directly at careers@quantumgridenergy.com', 'error');
            submitBtn.disabled = false;
            submitBtn.innerHTML = originalText;
        });
    } else {
